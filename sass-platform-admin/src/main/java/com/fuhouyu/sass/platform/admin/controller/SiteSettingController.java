...
public class SiteSettingController {
    ...
    public BaseResponse<Long> saveTenant(@RequestBody @Valid SaveOrEditTenantInfoDTO tenantInfoDTO) {
        return ResponseHelper.success(siteSettingService.save(tenantInfoDTO));
    }
    ...
    public BaseResponse<Long> editTenant(
        ...
        this.siteSettingService.editDetail(tenantInfoDTO);
    ...
    public BaseResponse<PageResultDTO<TenantInfoDTO>> pageList(TenantPageQueryDTO pageQueryDTO) {
        return ResponseHelper.success(siteSettingService.pageList(pageQueryDTO));
    }
    ...
    public BaseResponse<TenantInfoDetailDTO> getTenantInfo(@PathVariable("id") Long id) {
        return ResponseHelper.success(siteSettingService.findDetailById(id));
    }
    ...
    public BaseResponse<Boolean> deleteTenantInfo(@RequestBody @NotEmpty(message = "未选择需要删除的租户")
        ...
        return ResponseHelper.success(this.siteSettingService.removeByIds(ids));
    }
    ...
    public BaseResponse<Boolean> checkTenantCodeExists(@RequestParam("tenantCode") String tenantCode) {
        return ResponseHelper.success(Objects.nonNull(this.siteSettingService.findByTenantCode(tenantCode)));
    }
    ...
    public BaseResponse<List<BasicTenantDTO>> tenantList() {
        return ResponseHelper.success(this.siteSettingService.findTenantList());
    }
    ...
    public BaseResponse<TenantInfoDTO> findTenantForMe() {
        return ResponseHelper.success(this.siteSettingService.findDetailById(ContextHolderStrategy.getContext().getUser().getTenantId()));
    }
    ...
    public BaseResponse<Void> editStatus(@PathVariable("id") Long id,
        ...
        this.siteSettingService.edit(tenantInfoDTO);
        return ResponseHelper.success();
    }
    ...
    public BaseResponse<Void> resetPassword(@PathVariable("id") Long id) {
        this.siteSettingService.resetPassword(id);
        return ResponseHelper.success();
    }
