...
import {Col, Input, Row, TableColumnsType, Tag, Tree} from "antd";
...
export const OrganizationUserModal = ({onChange}: {
    onChange: (selectedRowKeys: Key[], selectedRows: Userinfo[], info: {
