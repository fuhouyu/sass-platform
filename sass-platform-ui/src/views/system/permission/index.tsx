...
import { PermissionConstant } from '@/constants/permissionConstant.ts';
...
const Permission: FC = () => {
    ...
    const handleForm = async () => {
        ...
        try {
            ...
            await (updateId
                ? permissionApi.editInfoApi(updateId, values)
                : permissionApi.saveInfoApi(values));
                            ...
                            components={[
                                <>
                                    ...
                                    <Input
                                        ...
                                        id={'permissionName'}
                                        onChange={e =>
                                            setPermissionQuery({ permissionName: e.target.value })
                                        }
                                    />
                                </>,
                            ]}
                                ...
                                <>
                                    ...
                                    >
                                        <Popconfirm
                                            ...
                                            onConfirm={async () => {
                                                permissionApi
                                                    .deleteInfoApi(rowKeys as string[])
                                                    .then();
                                                await tableRef?.current?.refreshPageList();
                                                await permissionTreeSelect();
                                            }}
                                        >
                                            <DeleteButton
                                                disabled={
                                                    rowKeys === undefined || rowKeys.length === 0
                                                }
                                            />
                                        </Popconfirm>
                                    </PermissionButton>
                ...
                >
                    ...
                    <Row gutter={24}>
                        <Col span={12}>
                            <Form.Item
                                ...
                                labelCol={{
                                    span: language === CommonConstant.ZH_CN_LANGUAGE ? 6 : 10,
                                }}
                                name="permissionName"
                                key="permissionName"
                                colon={false}
                        ...
                        <Col span={12}>
                                              ...
                                              () => ({
                                                  validator: async (_, value: string) => {
                                                      ...
                                                      const exists: boolean =
                                                          await permissionApi.checkPermissionCodeExistsApi(
                                                              concatPermissionCode(value),
                                                          );
                                                      if (exists) {
                                                          return Promise.reject(
                                                              new Error(
                                                                  t(
                                                                      'Permission.codeExistsErrorMessage',
                                                                  ),
                                                              ),
                                                          );
                                                      }
                            ...
                            >
                                <Input
                                    ...
                                    suffix={
                                        <Tooltip title={t('Permission.codeTips')}>
                    ...
                    <Row gutter={24}>
                        ...
                        <Col span={12}>
                            <Form.Item
                                labelCol={{
                                    span: language === CommonConstant.ZH_CN_LANGUAGE ? 6 : 9,
                                }}
                                ...
                                <Row gutter={24}>
                                    <Col span={12}>
                                        <Form.Item
                                            labelCol={{
                                                span:
                                                    language === CommonConstant.ZH_CN_LANGUAGE
                                                        ? 6
                                                        : 10,
                                            }}
                                    ...
                                    <Col span={12}>
                                        ...
                                        >
                                            <Input
                                                placeholder={t('Permission.routePath')}
                                                maxLength={20}
                            ...
                            form.getFieldValue('permissionType') === 'MENU' && (
                                <Row gutter={24}>
                                            ...
                                            rules={[
                                                {
                                                    ...
                                                    type: 'string',
                                                    message: t(
                                                        'Permission.componentPathCheckMessage',
                                                    ),
                                                },
                                            ]}
                                        >
                                            <Input
                                                placeholder={t(
                                                    'Permission.componentPathPlaceholder',
                                                )}
                                                maxLength={50}
                                            />
                                        </Form.Item>
                                    ...
                                    <Col span={12}>
                                        ...
                                        >
                                            <Input
                                                placeholder={t('Permission.routeParamsPlaceholder')}
                                                maxLength={100}
                                            />
                                        </Form.Item>
                                    </Col>
