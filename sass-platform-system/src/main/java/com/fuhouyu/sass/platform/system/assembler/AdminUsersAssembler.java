 ...
 */
@Mapper
public interface AdminUsersAssembler extends BaseAssembler<AdminUsers, AdminUserDTO> {

    AdminUsersAssembler INSTANCE = Mappers.getMapper(AdminUsersAssembler.class);
}
