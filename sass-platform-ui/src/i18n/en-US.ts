...
const EnUS = {
  ...
  Menu: {
    ...
    accountsSetting: 'Accounts Setting',
    addMember: 'Add User',
  ...
  Resource: {
    ...
    info: 'Resource Info',
    name: 'File Name',
    namePlaceholder: 'Please enter the file name',
    size: 'File Size',
    type: 'File Type',
    preview: 'Preview',
    download: 'Download',
    ...
    upload: {
      ...
      status: "Status",
      progress: "Progress",
      tips: "Drag files here, or <strong>click to upload</strong>",
      dragTips: "Drag files here, or click to upload",
      successTips: "File <strong>{{name}}</strong> uploaded successfully",
      errorTips: "File <strong>{{name}}</strong> upload failed, please try again",
      cancel: "Cancel Upload",
      canceledTips: "File <strong>{{name}}</strong> has been canceled",
      pending: "Preparing",
      uploading: "Uploading",
    ...
    permissionPlaceholder: 'Please select the resource permission',
    public: 'Public',
    private: 'Private',
