 ...
 */
@Mapper
public interface TenantSpaceAssembler extends BaseAssembler<TenantSpace, TenantSpaceDTO> {

    TenantSpaceAssembler INSTANCE = Mappers.getMapper(TenantSpaceAssembler.class);
